...
- [ ] Task 6 — Boundary test `phase31-boundaries.test.ts`
  - Acceptance Criteria:
...
- [ ] Task 7 — Docs: update `system-prompts.md`, discovery + CLI cross-refs, index, add compile-checked example
  - Acceptance Criteria:
...
- [ ] Task 8 — Final verification: typecheck, tests, example compile, docs checks
  - Acceptance Criteria:
