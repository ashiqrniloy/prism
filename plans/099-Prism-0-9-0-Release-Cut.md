...
- [x] Task 3: Migration page, CHANGELOG, docs index
  ...
  - Notes (executed 2026-09-19):
    ...
    - Root artifact after the new page: packed 1,426,360 (+0.85%), unpacked 4,683,379 (+0.78%), file count 534 (+1 page) against the Task 0 baselines — inside the gate's tolerance (`scripts/budget-gate.test.mjs` 37 pass), so no second rebaseline was needed for a docs-only addition.
