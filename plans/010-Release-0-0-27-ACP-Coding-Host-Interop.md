...
- [x] Task 11 — Host FR: export the DOM-free A2UI core from `@arnilo/prism-ag-ui/renderer` (release update in 0.0.27)
  - Completion Record (2026-08-07):
