import { createGoogleWorkspaceCliAdapter, createMemoryIdempotencyStore, createMicrosoft365CliAdapter, createWorkTools, normalizeMailPage, } from "@arnilo/prism-work-tools";
const identity = {
    tenantId: "tenant-a",
    userId: "user-1",
