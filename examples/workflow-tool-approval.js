...
import { agentNode, createMemoryWorkflowCheckpoints, defineWorkflow, resumeWorkflow, runWorkflow, toolNode, } from "@arnilo/prism-workflows";
...
export async function demo() {
    ...
    const events = [];
    const suspended = await runWorkflow(workflow, { repo: "my-project" }, {
    ...
    const toolOutput = result.outputs.scan;
    return {
