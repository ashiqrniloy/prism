...
import { assertEvaluationThreshold, defineDataset, defineScorer, scoreRun, serializeEvaluationReport, } from "@arnilo/prism-evals";
...
try {
    ...
    evaluations.push(...(await scoreRun({
        result: {
            sessionId: "ex",
...
console.log(serializeEvaluationReport({
