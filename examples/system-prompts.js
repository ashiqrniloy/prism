...
export function demo() {
    const config = [
        { id: "pkg", source: "package", mode: "append", text: "Package policy." },
        { id: "app", source: "app", mode: "append", text: "App policy." },
    ];
    const run = [{ id: "run", source: "run", mode: "append", text: "Run note." }];
