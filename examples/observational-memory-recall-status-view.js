...
import { createMemoryStatusCommand, createMemoryViewCommand, createObservationalMemoryExtension, createRecallMemoryTool, recallObservationalMemory, } from "@arnilo/prism-compaction-observational-memory";
...
export async function demo() {
    const getEntries = async (_sessionId) => [];
