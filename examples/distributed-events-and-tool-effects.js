import { createMemoryAgentEventSource, createMemoryToolEffectStore, createToolRegistry, dispatchToolCall, } from "@arnilo/prism";
/**
...
export async function demo() {
    const ownership = { tenantId: "tenant-a", accountId: "account-1", userId: "user-1" };
    const identity = {
        tenantId: "tenant-a",
        accountId: "account-1",
        userId: "user-1",
    ...
    const call = { type: "tool_call", id: "call-1", name: "mail.send", arguments: {} };
    const base = {
        call,
    ...
    const unknownCall = {
        call: { type: "tool_call", id: "call-2", name: "mail.send", arguments: {} },
