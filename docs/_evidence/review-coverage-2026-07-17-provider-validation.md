...
| --- | --- | --- |
| `listNeuralWattModels({ apiKey?, fetch?, baseUrl?, signal?, headers? })` | `packages/prism-providers/src/neuralwatt/src/models.ts` | **Template** — only shipped `list*Models` today |
