...
- **Tarball filenames.** npm strips the `@scope/` prefix, so the core package `@arnilo/prism` produces a tarball named `arnilo-prism-0.5.1.tgz`; family packages produce `arnilo-prism-core-0.5.1.tgz`, `arnilo-prism-coding-tools-0.5.1.tgz`, `arnilo-prism-providers-0.5.1.tgz` (all 19 adapters inside), `arnilo-prism-memory-0.5.1.tgz`, `arnilo-prism-web-tools-0.5.1.tgz`, and `arnilo-prism-office-0.5.1.tgz`; capability packages like `arnilo-prism-mcp-0.5.1.tgz` carry their own package version. Independent-package tags carry their own version. The CLI bin name `prism` is unaffected by the package name (`npx prism` still works; npm allows the bin field to differ from the package name).
