...
const FROZEN_TYPE_EXPORTS: readonly string[] = [
  ...
  "DefaultRetryPolicyOptions", "DispatchToolCallOptions", "DocumentContent", "DuplicateRegistrationOptions", "GuardrailRunResult",
  ...
  "AgentRunLifecycle", "AgentRunLifecycleAgent", "AgentRunLifecycleOptions", "AgentRunLifecycleRequest", "RunGuardrailsOptions", "RunLimitCounters", "RunLimitName", "RunLimitTrackerOptions", "SecureAgentOptions", "StoredAgentRunState", "UseCaseModelBinding",
