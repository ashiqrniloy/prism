...
const FROZEN_VALUE_EXPORTS: readonly string[] = [
  "CHECKPOINT_CONFLICT_CODE", "CheckpointConflictError", "LEASE_CONFLICT_CODE", "LeaseConflictError", "PermissionDeniedError", "SESSION_APPEND_CONFLICT_CODE", "SESSION_ENTRY_KINDS",
  ...
  "resolveLoop", "resolveRunProviderOptions", "resolveToolConcurrency", "runInstructionInjectors", "sanitizeCacheKey", "singleShotLoop", "sniffMediaMimeType",
...
const REQUIRED_SDK_CONTRACT_TYPES: readonly string[] = [
  ...
  "SessionEntry", "SessionStore", "RunLedger", "CheckpointStore", "LeaseStore", "ProductionPersistenceStore",
...
const FROZEN_TYPE_EXPORTS: readonly string[] = [
  ...
  "ManifestResourceDeclaration", "MediaContentBlock", "MediaContentBounds", "MediaMimePolicy", "MemoryCheckpointStoreOptions", "MemoryCredentialStore", "Middleware",
  ...
  "ProviderRegistry", "ProviderRegistryOptions", "ProviderResolver", "ResolvedMediaContent", "ResolveMediaContentOptions",
