...
const FROZEN_VALUE_EXPORTS: readonly string[] = [
  ...
  "LeaseConflictError", "MAX_GUARDRAIL_CONCURRENCY", "PermissionDeniedError", "RunLimitError", "RunLimitTracker",
  ...
  "createMemoryCredentialStore", "createMemoryLeaseStore", "createMemoryRunFeedbackStore", "createMemorySessionStore",
  ...
  "DEFAULT_MAX_STRUCTURED_OUTPUT_SCHEMA_BYTES", "DEFAULT_MEDIA_FETCH_TIMEOUT_MS", "definePrismManifest",
  ...
  "normalizeThinkingLevel", "parseAgentFile", "parsePrismManifest", "parseSkillFile", "prepareRunFeedback",
...
const FROZEN_TYPE_EXPORTS: readonly string[] = [
  ...
  "ExtensionKernel", "ExtensionKernelOptions", "FileContent", "ExecutionAction", "ExecutionDecision",
