...
export function buildMicrosoft365Argv(op: Microsoft365Op, args: JsonObject): string[] {
  switch (op) {
    ...
    case "file.get":
      throw new WorkToolError("ERR_PRISM_WORK_CAPABILITY", "file.get requires the Microsoft 365 HTTP adapter");
    case "file.add":
      return [
        "file",
        "add",
...
export function createMicrosoft365CliAdapter(options: Microsoft365CliAdapterOptions): Microsoft365Adapter {
  ...
  if (allowedOps.has("file.get")) throw new WorkToolError("ERR_PRISM_WORK_CAPABILITY", "file.get requires the Microsoft 365 HTTP adapter");
