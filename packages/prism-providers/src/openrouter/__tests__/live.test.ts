...
// `PRISM_LIVE_PROVIDER_TESTS=1` AND `OPENROUTER_API_KEY` are set. The default
// `npm test` and CI release verification never set these. To run locally:
//
//   PRISM_LIVE_PROVIDER_TESTS=1 OPENROUTER_API_KEY=sk-or-... \
//     npm run test --workspace=@arnilo/prism-providers/openrouter
//
...
describe("@arnilo/prism-providers/openrouter live tests", () => {
