...
describe("@arnilo/prism-providers/openrouter skeleton", () => {
  it("workspace_packages_export_provider_package_factories", () => {
    const source = readFileSync("src/openrouter/index.ts", "utf8");
    assert.match(source, /export function createOpenRouterProviderPackage/);
