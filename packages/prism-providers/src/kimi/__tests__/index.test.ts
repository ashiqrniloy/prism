...
describe("@arnilo/prism-providers/kimi skeleton", () => {
  it("workspace_packages_export_provider_package_factories", () => {
    const source = readFileSync("src/kimi/index.ts", "utf8");
    assert.match(source, /export function createKimiProviderPackage/);
