...
const featured: readonly ClinePassModelConfig[] = [
  ...
  row(
    ...
    CLINEPASS_THINKING_MAPS.kimiK3,
  ),
  row(
  ...
  row(
    ...
    CLINEPASS_THINKING_MAPS.deepseek,
  ),
  row(
  ...
  row(
    ...
    131_072,
    { input: 0.14, output: 0.28, cacheRead: 0.0028, cacheWrite: 0 },
    CLINEPASS_THINKING_MAPS.standard,
  ),
  row(
