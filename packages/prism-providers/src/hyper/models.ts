...
const FEATURED: readonly FeaturedMeta[] = [
  {
    ...
    cost: { input: 0.2, output: 0.4, cacheRead: 0.04, currency: "USD", unit: "per_million_tokens" },
    compat: { reasoning_effort: "high", effortLevels: ["high", "xhigh"] },
  },
  {
    model: "deepseek-v4-flash-0731",
    displayName: "DeepSeek V4 Flash 0731",
    limits: { contextWindow: 1_000_000, maxOutputTokens: 384_000 },
    cost: { input: 0.44, output: 1.32, cacheRead: 0.044, currency: "USD", unit: "per_million_tokens" },
    compat: { reasoning_effort: "high", effortLevels: ["none", "low", "high", "max"] },
  },
  {
  ...
  },
  {
    ...
    limits: { contextWindow: 1_048_576, maxOutputTokens: 262_144 },
    cost: { input: 1.437216, output: 4.311648, cacheRead: 0.0479072, currency: "USD", unit: "per_million_tokens" },
    compat: { reasoning_effort: "high", effortLevels: ["none", "low", "high", "max"] },
  },
  {
    model: "gemma-4-26b-a4b-it",
    displayName: "Gemma 4 26B A4B",
    limits: { contextWindow: 256_000, maxOutputTokens: 25_600 },
    cost: { input: 0.116, output: 0.38, cacheWrite: 0.058, currency: "USD", unit: "per_million_tokens" },
  },
  {
    model: "glm-5",
    displayName: "GLM-5",
    limits: { contextWindow: 202_752, maxOutputTokens: 20_275 },
    cost: { input: 0.85, output: 2.774, cacheWrite: 0.425, currency: "USD", unit: "per_million_tokens" },
  },
  {
    model: "glm-5.1",
    displayName: "GLM-5.1",
    limits: { contextWindow: 202_750, maxOutputTokens: 3_276 },
    cost: { input: 1.29, output: 4.22, cacheWrite: 0.645, currency: "USD", unit: "per_million_tokens" },
  },
  {
    model: "glm-5.2",
    displayName: "GLM-5.2",
    limits: { contextWindow: 1_000_000, maxOutputTokens: 32_768 },
    cost: { input: 1.52432, output: 4.79072, cacheRead: 0.152432, currency: "USD", unit: "per_million_tokens" },
    compat: { reasoning_effort: "high", effortLevels: ["high", "xhigh"] },
  },
  {
    model: "glm-5.3",
    displayName: "GLM-5.3",
    limits: { contextWindow: 1_048_576, maxOutputTokens: 262_144 },
    cost: { input: 1.52432, output: 4.79072, cacheRead: 0.283088, currency: "USD", unit: "per_million_tokens" },
    compat: { reasoning_effort: "high", effortLevels: ["low", "high", "max"] },
  },
  {
    model: "glm-5.3-flash",
    displayName: "GLM-5.3 Flash",
    limits: { contextWindow: 1_048_576, maxOutputTokens: 131_072 },
    cost: { input: 0.16332, output: 0.5444, cacheRead: 0.0315752, currency: "USD", unit: "per_million_tokens" },
    compat: { reasoning_effort: "high", effortLevels: ["low", "high", "max"] },
  ...
  },
  {
    ...
    limits: { contextWindow: 128_072, maxOutputTokens: 13_107 },
    cost: { input: 0.188, output: 0.7, cacheWrite: 0.094, currency: "USD", unit: "per_million_tokens" },
    compat: { reasoning_effort: "medium", effortLevels: ["none", "minimal", "low", "medium", "high", "xhigh", "max"] },
  },
  {
    model: "kimi-k2.5",
    displayName: "Kimi K2.5",
    limits: { contextWindow: 262_144, maxOutputTokens: 26_214 },
    cost: { input: 0.5284, output: 2.785, cacheWrite: 0.2642, currency: "USD", unit: "per_million_tokens" },
  },
  {
    model: "kimi-k2.6",
    displayName: "Kimi K2.6",
    limits: { contextWindow: 262_000, maxOutputTokens: 26_214 },
    cost: { input: 1.03436, output: 4.3552, cacheRead: 0.174208, currency: "USD", unit: "per_million_tokens" },
    compat: { reasoning_effort: "medium", effortLevels: ["low", "medium", "high"] },
    capabilities: { input: ["text", "image"], output: ["text"], reasoning: true, tools: true, streaming: true },
  },
  {
    model: "kimi-k2.7-code",
    displayName: "Kimi K2.7 Code",
    limits: { contextWindow: 262_000, maxOutputTokens: 16_000 },
    cost: { input: 1.03436, output: 4.3552, cacheRead: 0.206872, currency: "USD", unit: "per_million_tokens" },
    capabilities: { input: ["text", "image"], output: ["text"], reasoning: true, tools: true, streaming: true },
  },
  {
    model: "kimi-k3",
    displayName: "Kimi K3",
    limits: { contextWindow: 1_048_576, maxOutputTokens: 16_000 },
    cost: { input: 3.2664, output: 16.332, cacheRead: 0.32664, currency: "USD", unit: "per_million_tokens" },
    compat: { reasoning_effort: "max", effortLevels: ["low", "high", "max"] },
    capabilities: { input: ["text", "image"], output: ["text"], reasoning: true, tools: true, streaming: true },
  },
  {
    model: "llama-3.3-70b-instruct",
    displayName: "Llama 3.3 70B Instruct",
    limits: { contextWindow: 128_000, maxOutputTokens: 12_800 },
    cost: { input: 0.6066, output: 1.0386, cacheWrite: 0.3033, currency: "USD", unit: "per_million_tokens" },
  },
  {
    model: "llama-4-maverick-17b-128e-instruct-fp8",
    displayName: "Llama 4 Maverick 17B 128E",
    limits: { contextWindow: 430_000, maxOutputTokens: 43_000 },
    cost: { input: 0.274, output: 0.8992, cacheWrite: 0.137, currency: "USD", unit: "per_million_tokens" },
  },
  {
    model: "minimax-m2.7",
    displayName: "MiniMax M2.7",
    limits: { contextWindow: 262_100, maxOutputTokens: 6_553 },
    cost: { input: 0.426, output: 1.62, cacheWrite: 0.213, currency: "USD", unit: "per_million_tokens" },
  },
  {
    model: "minimax-m3",
    displayName: "MiniMax M3",
    limits: { contextWindow: 512_000, maxOutputTokens: 512_000 },
    cost: { input: 0.32664, output: 1.30656, cacheRead: 0.0642392, currency: "USD", unit: "per_million_tokens" },
    compat: { reasoning_effort: "medium", effortLevels: ["low", "medium", "high"] },
    capabilities: { input: ["text", "image"], output: ["text"], reasoning: true, tools: true, streaming: true },
  },
  {
    ...
    route: "anthropic",
    limits: { contextWindow: 1_000_000, maxOutputTokens: 64_000 },
    cost: { input: 1, output: 4, cacheRead: 0.1, cacheWrite: 1.25, currency: "USD", unit: "per_million_tokens" },
    capabilities: { input: ["text", "image"], output: ["text"], reasoning: true, tools: true, streaming: true },
  },
  {
    model: "qwen3.6-max",
  ...
  },
  {
    ...
    route: "anthropic",
    limits: { contextWindow: 1_000_000, maxOutputTokens: 64_000 },
    cost: { input: 2, output: 6, cacheRead: 0.2, cacheWrite: 2.5, currency: "USD", unit: "per_million_tokens" },
    capabilities: { input: ["text", "image"], output: ["text"], reasoning: true, tools: true, streaming: true },
  },
  {
    model: "qwen3.7-flash",
    ...
    limits: { contextWindow: 1_000_000, maxOutputTokens: 64_000 },
    cost: { input: 0.2, output: 0.8, cacheRead: 0.04, currency: "USD", unit: "per_million_tokens" },
    capabilities: { input: ["text", "image"], output: ["text"], reasoning: true, tools: true, streaming: true },
  },
  {
    model: "qwen3.7-max",
    ...
    limits: { contextWindow: 1_000_000, maxOutputTokens: 64_000 },
    cost: { input: 2.5, output: 7.5, cacheRead: 0.5, currency: "USD", unit: "per_million_tokens" },
  },
  {
    model: "qwen3.7-plus",
    displayName: "Qwen 3.7 Plus",
    limits: { contextWindow: 1_000_000, maxOutputTokens: 64_000 },
    cost: { input: 1.2, output: 4.8, cacheRead: 0.24, currency: "USD", unit: "per_million_tokens" },
    capabilities: { input: ["text", "image"], output: ["text"], reasoning: true, tools: true, streaming: true },
  },
  {
  ...
  },
  {
    ...
    limits: { contextWindow: 1_000_000, maxOutputTokens: 128_000 },
    cost: { input: 0.5, output: 3, cacheRead: 0.1, currency: "USD", unit: "per_million_tokens" },
    capabilities: { input: ["text", "image"], output: ["text"], reasoning: true, tools: true, streaming: true },
  },
  {
    model: "qwen3.8-flash",
    ...
    limits: { contextWindow: 1_000_000, maxOutputTokens: 128_000 },
    cost: { input: 0.15, output: 0.47, cacheRead: 0.016, currency: "USD", unit: "per_million_tokens" },
    capabilities: { input: ["text", "image"], output: ["text"], reasoning: true, tools: true, streaming: true },
  },
  {
    model: "qwen3.8-max",
  ...
  },
  {
    ...
    limits: { contextWindow: 106_000, maxOutputTokens: 10_600 },
    cost: { input: 0.445, output: 2.145, cacheWrite: 0.2225, currency: "USD", unit: "per_million_tokens" },
  },
  {
    model: "qwen3-next-80b-a3b-instruct",
    displayName: "Qwen3 Next 80B A3B",
    limits: { contextWindow: 262_144, maxOutputTokens: 26_214 },
    cost: { input: 0.1175, output: 1.136, cacheWrite: 0.05875, currency: "USD", unit: "per_million_tokens" },
  },
];
