...
describe("@arnilo/prism-providers/opencode-go skeleton", () => {
  it("workspace_packages_export_provider_package_factories", () => {
    const source = readFileSync("src/opencode-go/index.ts", "utf8");
    assert.match(source, /export function createOpenCodeGoProviderPackage/);
