...
const fixtureRoot = resolve(import.meta.dirname, "../../../fixtures/caveman/upstream-full");
const minimalRoot = resolve(import.meta.dirname, "../../../fixtures/caveman/upstream-minimal");
