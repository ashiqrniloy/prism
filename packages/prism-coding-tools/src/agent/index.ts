// @arnilo/prism-coding-tools/agent public barrel.
//
...
export type {
  ...
  ProcessExitResult,
  ProcessOutputChunk,
  // host-selected PTY backend: pass ptyBackend to createProcessSessions to
  // enable pty: true (delegates only to the host adapter; see process/types.ts)
  ProcessPtyBackend,
  ProcessPtyHandle,
