...
const fixtureRoot = resolve(import.meta.dirname, "../../../fixtures/ponytail/upstream-full");
const minimalRoot = resolve(import.meta.dirname, "../../../fixtures/ponytail/upstream-minimal");
