...
const fixtureRoot = resolve(import.meta.dirname, "../../../fixtures/ponytail/upstream-minimal");
...
describe("ponytail extension scaffold", () => {
  ...
  it("setup_with_fixture_upstream_registers_contributions", async () => {
    ...
    const fixtureFull = resolve(import.meta.dirname, "../../../fixtures/ponytail/upstream-full");
    const extension = createPonytailExtension({
