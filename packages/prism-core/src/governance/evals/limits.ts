...
/** Frozen ceiling for one curated dataset item (datasetFromRuns); not configurable. */
export const HARD_CURATION_ITEM_MAX_BYTES = 4 * 1024 * 1024;
...
export const DEFAULT_MAX_STEP_SCORES = 32;
export const HARD_MAX_STEP_SCORES = 128;
export const DEFAULT_TRIALS_COUNT = 1;
export const HARD_MAX_TRIALS = 16;
