...
function getPgPoolConstructor(): new (config?: PoolConfig) => Pool {
  try {
    ...
    throw new EnterprisePostgresError(
      "@arnilo/prism-core/enterprise/postgres: optional peer dependency 'pg' is not installed. " +
        "Install it (npm i pg) to use enterprise PostgreSQL state.",
