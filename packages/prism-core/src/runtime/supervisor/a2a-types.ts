...
export type A2ATaskEvent =
  ...
  | {
      ...
      readonly statusUpdate: { readonly taskId: string; readonly contextId: string; readonly status: A2ATask["status"] };
    }
  | {
      readonly eventId: string;
...
export interface A2APushProvider {
  ...
  list(input: {
    ...
    readonly authorization: A2AAuthorization;
    readonly signal: AbortSignal;
  }): Promise<{ readonly configs: readonly A2APushConfig[]; readonly nextPageToken?: string }>;
  delete(input: {
    readonly taskId: string;
    readonly id: string;
    readonly authorization: A2AAuthorization;
...
export interface A2AClient {
  ...
  listPushConfigs(
    taskId: string,
    options?: { readonly signal?: AbortSignal; readonly pageSize?: number; readonly pageToken?: string },
  ): Promise<{ readonly configs: readonly A2APushConfig[]; readonly nextPageToken?: string }>;
