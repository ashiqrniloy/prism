...
export function workflowLoopIterationId(workflowId: string, runId: string, nodeId: string, iteration: number, tenantId?: string): string {
  return [tenantId, workflowId, runId, nodeId, String(iteration)]
