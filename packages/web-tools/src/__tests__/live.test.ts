...
it("Brave least-privilege live search", { skip: !live || !process.env.PRISM_BRAVE_SEARCH_TOKEN, timeout: 30_000 }, async () => {
...
it("Exa least-privilege live search", { skip: !live || !process.env.PRISM_EXA_API_KEY, timeout: 30_000 }, async () => {
...
it("Firecrawl least-privilege live fetch", { skip: !live || !process.env.PRISM_FIRECRAWL_API_KEY, timeout: 30_000 }, async () => {
