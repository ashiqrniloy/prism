 ...
 * The resulting browser plugs straight into @arnilo/prism-browser's
...
import type { PlaywrightBrowser } from "@arnilo/prism-browser";
 ...
 * connectOverCDP call is made and its browser is returned for @arnilo/prism-browser.
 */
